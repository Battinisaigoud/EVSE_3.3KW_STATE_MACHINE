// 1 "D:\\Current_Project_15-10-2022\\Current_project_13-12-2022\\Testing_Issues\\Testing_Issues_15-02-2023\\POD_EVRE_GENERIC_IOCL_14-03-2023\\POD_EVRE_GENERIC\\src\\FOTA_OCPP.cpp"
/*
 * FOTA_OCPP.cpp
 * 
...
void FotaNotification::processReq(JsonObject payload) {
	...
	FOTA_preference.putString("fota_uri", uri);
	FOTA_preference.putUInt("fota_retries", retries);
	FOTA_preference.putString("fota_date", date);
	FOTA_preference.putBool("fota_avial", true);
